...
# Filename       : <file_name> 
# Created on     : Sun 20 Oct 2013 12:10:01 AM IST
# Author         : Dilawar Singh
# Email          : dilawars@ncbs.res.in
#
# Description    : moose functions to create elements.
#
# Logs           :
# Sun 20 Oct 2013 12:10:13 AM IST 
#   : Copied proto18.py file from Demo/snippets/MULTI
...
def make_Ca_FromXML( xmlElem ) :
  '''
  Read an xml element and construct a HH Ca channel. 
  '''
