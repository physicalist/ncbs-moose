...
for(iNeuronIndex=1; iNeuronIndex <= {N_NEURON}; iNeuronIndex = iNeuronIndex + 1)
	setrank {iNeuronIndex}
	create Neutral /neuron{iNeuronIndex}
	make_neuron /neuron{iNeuronIndex}
end
setrank 0
...
setrank 1
setfield /neuron1/c1 inject {INJECT}
setrank 0
...
for(iNeuronIndex=1; iNeuronIndex <= {N_NEURON}; iNeuronIndex = iNeuronIndex + 1)
	setrank {iNeuronIndex}
	setfield /neuron{iNeuronIndex}/V1 print "squid.plot1"{iNeuronIndex}
	setfield /neuron{iNeuronIndex}/Vm print "squid.plot2"{iNeuronIndex}
end
setrank 0
