...
class SquidDemo(QtGui.QMainWindow):
    ...
    def slotRun(self):
        ...
        self.requestQueue.put([sqthr.SquidThread.DO_RUN, totalTime, preTime, pulseWidth, updateInterval, injectBase, injectHigh])
...
#            self.squidThread.updateEvent
            vm = self.squidThread.queue.get(True, 0.10)
