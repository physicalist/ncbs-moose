...
create Neutral /axon
make_compartment /axon/c1 {RA} {RM} {CM} {EM} {INJECT} {DIAMETER} {LENGTH}

int i
for ( i = 2; i <= {N_COMPARTMENT}; i = i + 1 )
	make_compartment /axon/c{i} {RA} {RM} {CM} {EM} 0.0 {DIAMETER} {LENGTH}
...
setclock 0 {DT} 0
setclock 1 {DT} 1
useclock /axon/##[TYPE=Compartment] 0
useclock /solve 1
reset
...
call /solve recordCompartmentIn /axon/c1
call /solve recordCompartmentIn /axon/c{N_COMPARTMENT}

step {SIMLENGTH} -t
call /solve printVoltageTraceIn "rall.3.plot" 1
setfield /sli_shell isInteractive 1
echo "Plot written to 'rall.3.plot'"
quit
