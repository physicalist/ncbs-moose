...
bool Compartment::rangeWarning( const string& field, double value )
{
	if ( value < Compartment::EPSILON ) {
		cout << "Warning: Ignored attempt to set " << field <<
				" of compartment " <<
				// c->target( const Eref& e, const Qinfo* q ).e->name( const Eref& e, const Qinfo* q ) << 
...
void Compartment::setVm( const Eref& e, const Qinfo* q, double Vm )
{
	Vm_ = Vm;
}

double Compartment::getVm( const Eref& e, const Qinfo* q ) const
{
	return Vm_;
}

void Compartment::setEm( const Eref& e, const Qinfo* q, double Em )
{
	Em_ = Em;
}

double Compartment::getEm( const Eref& e, const Qinfo* q ) const
{
	return Em_;
}

void Compartment::setCm( const Eref& e, const Qinfo* q, double Cm )
{
	if ( rangeWarning( "Cm", Cm ) ) return;
	Cm_ = Cm;
}

double Compartment::getCm( const Eref& e, const Qinfo* q ) const
{
	return Cm_;
}

void Compartment::setRm( const Eref& e, const Qinfo* q, double Rm )
{
...
double Compartment::getRm( const Eref& e, const Qinfo* q ) const
{
	return Rm_;
}

void Compartment::setRa( const Eref& e, const Qinfo* q, double Ra )
{
	if ( rangeWarning( "Ra", Ra ) ) return;
	Ra_ = Ra;
}

double Compartment::getRa( const Eref& e, const Qinfo* q ) const
{
	return Ra_;
}

//~ void Compartment::setIm( const Eref& e, const Qinfo* q, double Im )
//~ {
	//~ Im_ = Im;
//~ }

double Compartment::getIm( const Eref& e, const Qinfo* q ) const
{
	return lastIm_;
}

void Compartment::setInject( const Eref& e, const Qinfo* q, double Inject )
{
	Inject_ = Inject;
}

double Compartment::getInject( const Eref& e, const Qinfo* q ) const
{
	return Inject_;
}

void Compartment::setInitVm( const Eref& e, const Qinfo* q, double initVm )
{
	initVm_ = initVm;
}

double Compartment::getInitVm( const Eref& e, const Qinfo* q ) const
{
	return initVm_;
}

void Compartment::setDiameter( const Eref& e, const Qinfo* q, double value )
{
	diameter_ = value;
}

double Compartment::getDiameter( const Eref& e, const Qinfo* q ) const
{
	return diameter_;
}

void Compartment::setLength( const Eref& e, const Qinfo* q, double value )
{
	length_ = value;
}

double Compartment::getLength( const Eref& e, const Qinfo* q ) const
{
	return length_;
}

void Compartment::setX0( const Eref& e, const Qinfo* q, double value )
{
	x0_ = value;
}

double Compartment::getX0( const Eref& e, const Qinfo* q ) const
{
	return x0_;
}

void Compartment::setY0( const Eref& e, const Qinfo* q, double value )
{
	y0_ = value;
}

double Compartment::getY0( const Eref& e, const Qinfo* q ) const
{
	return y0_;
}

void Compartment::setZ0( const Eref& e, const Qinfo* q, double value )
{
	z0_ = value;
}

double Compartment::getZ0( const Eref& e, const Qinfo* q ) const
{
	return z0_;
}

void Compartment::setX( const Eref& e, const Qinfo* q, double value )
{
	x_ = value;
}

double Compartment::getX( const Eref& e, const Qinfo* q ) const
{
	return x_;
}

void Compartment::setY( const Eref& e, const Qinfo* q, double value )
{
	y_ = value;
}

double Compartment::getY( const Eref& e, const Qinfo* q ) const
{
	return y_;
}

void Compartment::setZ( const Eref& e, const Qinfo* q, double value )
{
	z_ = value;
}

double Compartment::getZ( const Eref& e, const Qinfo* q ) const
{
	return z_;
}
...
void Compartment::process( const Eref& e, ProcPtr p )
{
	...
	CompartmentWrapper::VmOut()->send( e, p->threadIndexInGroup, Vm_ );
...
void Compartment::innerInitProc( const Eref& e, ProcPtr p )
{
	...
	CompartmentWrapper::axialOut()->send( e, p->threadIndexInGroup, Vm_ );
	
	// Send out the raxial messages
	CompartmentWrapper::raxialOut()->send( e, p->threadIndexInGroup, Ra_, Vm_ );
}
...
void Compartment::handleChannel( const Eref& e, const Qinfo* q, double Gk, double Ek )
{
	A_ += Gk * Ek;
	B_ += Gk;
}

void Compartment::handleRaxial( const Eref& e, const Qinfo* q, double Ra, double Vm )
{
	A_ += Vm / Ra;
	B_ += 1.0 / Ra;
	Im_ += ( Vm - Vm_ ) / Ra;
...
void Compartment::handleAxial( const Eref& e, const Qinfo* q, double Vm )
{
	A_ += Vm / Ra_;
	B_ += 1.0 / Ra_;
	Im_ += ( Vm - Vm_ ) / Ra_;
...
void Compartment::injectMsg( const Eref& e, const Qinfo* q, double current )
{
	sumInject_ += current;
	Im_ += current;
}

void Compartment::randInject(
