...
{
public:
    /** The Cinfo intializer is used for static initialization of all the MOOSE
     * Cinfos. Each MOOSE class must set up a function to build its Cinfo. This
     * function must be called statically in the MOOSE class .cpp file.  Note
     * how it takes the base *Cinfo as an argument. This lets us call the base
     * Cinfo initializer when making each Cinfo class, thus ensuring the correct
     * static initialization sequence, despite the somewhat loose semantics for
     * this sequence in most C++ compilers.
     */
    ...
    // A handle to lots of utility functions for the Data class.
    DinfoBase* d,  
    const string* doc = 0,
