...
%MOOSE% moose_sbml_read_write.g >> NUL 2>& 1
...
%MOOSE% moose_readcell.g >> NUL 2>& 1
%NEARDIFF% moose_readcell.plot test.plot 5.0e-3
ECHO readcell2

IF EXIST test.plot ERASE test.plot

%MOOSE% moose_synchan.g >> NUL 2>& 1
...
%MOOSE% moose_channels.g >> NUL 2>& 1
ECHO channels
...
%MOOSE% moose_file2tab2file.g >> NUL 2>& 1
