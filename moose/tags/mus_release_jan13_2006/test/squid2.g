...
create HHGate2 /squid/Na/m
setfield /squid/Na/m power 3
create HHGate2 /squid/Na/h
...
//////////////////////////////////////////////////////////////////
// Set up squid2 here, Slight change in Rm from original.
//////////////////////////////////////////////////////////////////
create Compartment /squid2
setfield /squid2 Rm {RM * 1.1}
setfield /squid2 Ra {RA}
setfield /squid2 Cm {CM}
setfield /squid2 Em {VLEAK}
setfield /squid2 initVm {EREST}
create HHChannel /squid2/Na
setfield /squid2/Na Ek {VNa}
setfield /squid2/Na Gbar {GNa}
setfield /squid2/Na Xpower 3
setfield /squid2/Na Ypower 1

create HHChannel /squid2/K
setfield /squid2/K Ek {VK}
setfield /squid2/K Gbar {GK}
setfield /squid2/K Xpower 4

addmsg /squid2/channel /squid2/Na/channel
addmsg /squid2/channel /squid2/K/channel

// Here are the crucial messages.
addmsg /squid2/Na/xGate /squid/Na/m/gate
addmsg /squid2/Na/yGate /squid/Na/h/gate
addmsg /squid2/K/xGate /squid/K/n/gate

create Plot /Vm2
addmsg /Vm2/trigPlot /squid2/Vm

//////////////////////////////////////////////////////////////////
// Set up gate properties here.
//////////////////////////////////////////////////////////////////
...
useclock /##[TYPE=Compartment] 0
useclock /##[TYPE=Plot] 1

reset
setfield /squid Inject 0
setfield /squid2 Inject 0
step 0.005 -t
setfield /squid Inject {INJECT}
setfield /squid2 Inject {INJECT}
step 0.040 -t
setfield /squid Inject 0
setfield /squid2 Inject 0
step 0.005 -t
call /##[TYPE=Plot] printIn squid2.plot
setfield /sli_shell isInteractive 1
quit
